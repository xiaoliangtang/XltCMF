	...
	<div class="col-xs-12">
		<div class="tabbable">
			<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
				<li class="active">
					<a data-toggle="tab" href="#admin_list">管理员列表</a>
				</li>

				<li>
					<a data-toggle="tab" href="#admin_add">添加管理员</a>
				</li>
			...
			<div class="tab-content">
				<div id="admin_list" class="tab-pane in active">
				...
				<div id="admin_add" class="tab-pane">
