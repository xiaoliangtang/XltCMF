...
<html lang="en">
	...
	<div class="col-xs-12">
		<div class="tabbable">
			<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
				<li class="active">
					<a data-toggle="tab" href="#member_group_list">会员组列表</a>
				</li>

				<li>
					<a data-toggle="tab" href="#member_group_add">添加会员组</a>
				</li>

			</ul>

			<div class="tab-content">
				<div id="member_group_list" class="tab-pane in active">
				...
				<div id="member_group_add" class="tab-pane">
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" name="role_add" id="form_member_group_add" method="post" action="<?php echo U('User/role_runadd');?>">
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form" name="role_add" id="form_member_group_edit" method="post" action="<?php echo U('User/role_runadd');?>">
	...
	<script type="text/javascript">
		...
		$("#form_member_group_add").validate();
		$("$form_member_group_edit").validate();
