	...
	<div class="col-xs-12">
		<div class="tabbable">
			<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
				<li class="active">
					<a data-toggle="tab" href="#member_list">会员列表</a>
				</li>

				<li>
					<a data-toggle="tab" href="#member_add">添加会员</a>
				</li>

			</ul>

			<div class="tab-content">
				<div id="member_list" class="tab-pane in active">
							...
							<div class="row">
								<div class="col-xs-5">
									<div class="input-group">
										<input type="text" class="form-control search-query" placeholder="输入需要查询的会员名或者邮箱" />
				...
				<div id="member_add" class="tab-pane">
					<div class="page-content">

						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal memberform" name="member_list_add" method="post" action="<?php echo U('Member/member_runadd');?>">
