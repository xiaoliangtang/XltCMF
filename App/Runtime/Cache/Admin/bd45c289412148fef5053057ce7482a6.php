...
<html lang="en">
	...
	<link rel="stylesheet" href="/Public/plugins/ztree/css/zTreeStyle/zTreeStyle.css" type="text/css">
	...
	<div class="col-xs-12">
		<div class="tabbable">
			<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
				<li>
					<a href="<?php echo U('User/role');?>">角色列表</a>
				</li>

				<li>
					<a href="<?php echo U('User/role_add');?>">添加角色</a>
				</li>

				<li class="active">
					<a href="<?php echo U('User/role_access');?>">权限分配</a>
				</li>
								...
								<form class="form-horizontal form_role_access" role="form" name="role_add" method="post">
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<a class="btn btn-info" type="submit" id="btn_role_add" href="<?php echo U('User/role_runaccess',array('id'=>$id));?>">
	...
	<script type="text/javascript" src="/Public/plugins/ztree/js/jquery.ztree.core.js"></script>
	<script type="text/javascript" src="/Public/plugins/ztree/js/jquery.ztree.excheck.js"></script>
	...
	<script type="text/javascript">
		...
		var zNodes = <?php echo ($json_menus); ?>;
