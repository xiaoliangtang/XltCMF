					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" name="role_add" id="form_role_add" method="post" action="<?php echo U('User/role_runadd');?>">
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form" name="role_add" id="form_role_edit" method="post" action="<?php echo U('User/role_runadd');?>">
