	...
	<div class="col-xs-12">
		<div class="tabbable">
			<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
				<li class="active">
					<a data-toggle="tab" href="#menu_list">菜单列表</a>
				</li>

				<li>
					<a data-toggle="tab" href="#menu_add">添加菜单</a>
				</li>
			...
			<div class="tab-content">
													...
													<tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="#" data-toggle="modal" data-target="#addChildModal" data-id="">
																	<i class="icon-plus-sign bigger-130"></i>
																</a>

																<a class="green" href="#" data-toggle="modal" data-target="#editModal" data-id="">
				...
				<div id="menu_add" class="tab-pane">
					<div class="page-content">

						<div class="row">
							<div class="col-xs-12">

								<form class="form-horizontal ajaxForm2" name="admin_rule_copy" method="post" action="<?php echo U('admin_rule_runadd');?>">
										...
										<div class="col-sm-9">
											<select name="pid"  class="col-xs-10 col-sm-5" required>
												...
												{foreach name="admin_rule" item="v"}
													<option value="<?php echo ($v["id"]); ?>" {if condition="$v['id'] eq $pid"}selected{/if}><?php echo ($v["lefthtml"]); echo ($v["title"]); ?></option>
												{/foreach}
											</select>
										</div>
									</div>
