									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<?php if(is_array($navs)): $i = 0; $__LIST__ = $navs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($pid); ?>-<?php echo ($v["id"]); ?>">
														<td class="center">
															<label>
																<input type="checkbox" class="ace"
												...
												<tr>
													<td colspan="9" align="left">
														<a class="btn btn-sm btn-primary" id="btnsort" href="<?php echo U('Nav/nav_sort');?>">排序</a>
													</td>
												</tr>
