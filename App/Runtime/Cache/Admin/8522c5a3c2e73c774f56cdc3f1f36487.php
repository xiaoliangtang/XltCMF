					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">		
								...
								<form class="form-horizontal form_menu_edit" name="admin_rule_copy" method="post" action="<?php echo U('Menu/menu_runedit');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select name="pid_level"  class="col-xs-10 col-sm-5" required>
												...
												<?php if(is_array($menu_layer)): foreach($menu_layer as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>-<?php echo ($v["level"]); ?>" <?php if($v['id'] == $current_pid): ?>selected<?php endif; ?> ><?php echo ($v["lefthtml"]); echo ($v["title"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="title" id="title"  value="<?php echo ($menu["title"]); ?>"  class="col-xs-10 col-sm-5" required/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="name" id="name"  value="<?php echo ($menu["name"]); ?>"  class="col-xs-10 col-sm-5" required/>
                                            <span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="css" id="css"  value="<?php echo ($menu["css"]); ?>" class="col-xs-10 col-sm-5" />
				                            <span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9" style="padding-top:5px;">
											<input name="status" value="1" class="ace ace-switch ace-switch-5" <?php if($menu['status'] == 1): ?>checked<?php endif; ?> type="checkbox" />
											<span class="lbl"></span>
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="sort" id="sort"  value="<?php echo ($menu["sort"]); ?>" class="col-xs-10 col-sm-1" />
										</div>
									</div>
									<div class="space-4"></div>
